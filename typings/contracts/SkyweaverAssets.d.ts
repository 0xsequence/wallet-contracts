...
interface SkyweaverAssetsInterface extends Interface {
  functions: {
...
export class SkyweaverAssets extends Contract {
  connect(signerOrProvider: Signer | Provider | string): SkyweaverAssets;
  attach(addressOrName: string): SkyweaverAssets;
  deployed(): Promise<SkyweaverAssets>;

  on(event: EventFilter | string, listener: Listener): SkyweaverAssets;
  once(event: EventFilter | string, listener: Listener): SkyweaverAssets;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): SkyweaverAssets;
  removeAllListeners(eventName: EventFilter | string): SkyweaverAssets;
  removeListener(eventName: any, listener: Listener): SkyweaverAssets;

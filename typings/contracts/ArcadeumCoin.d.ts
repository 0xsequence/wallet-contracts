...
interface ArcadeumCoinInterface extends Interface {
  functions: {
...
export class ArcadeumCoin extends Contract {
  connect(signerOrProvider: Signer | Provider | string): ArcadeumCoin;
  attach(addressOrName: string): ArcadeumCoin;
  deployed(): Promise<ArcadeumCoin>;

  on(event: EventFilter | string, listener: Listener): ArcadeumCoin;
  once(event: EventFilter | string, listener: Listener): ArcadeumCoin;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): ArcadeumCoin;
  removeAllListeners(eventName: EventFilter | string): ArcadeumCoin;
  removeListener(eventName: any, listener: Listener): ArcadeumCoin;

  interface: ArcadeumCoinInterface;

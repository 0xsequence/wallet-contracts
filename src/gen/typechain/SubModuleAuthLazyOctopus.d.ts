...
interface SubModuleAuthLazyOctopusInterface extends ethers.utils.Interface {
  functions: {
...
export class SubModuleAuthLazyOctopus extends BaseContract {
  ...
  interface: SubModuleAuthLazyOctopusInterface;

...
export interface RequireUtils extends BaseContract {
  ...
  functions: {
    ...
    publishConfig(
      ...
      _members: RequireUtils.MemberStruct[],
      _index: PromiseOrValue<boolean>,
    ...
    publishInitialSigners(
      ...
      _sizeMembers: PromiseOrValue<BigNumberish>,
  ...
  filters: {
    "RequiredConfig(address,bytes32,uint256,bytes)"(
      ...
      _imageHash?: PromiseOrValue<BytesLike> | null,
      _threshold?: null,
      _signers?: null
    ): RequiredConfigEventFilter;
    RequiredConfig(
      _wallet?: PromiseOrValue<string> | null,
      _imageHash?: PromiseOrValue<BytesLike> | null,
      _threshold?: null,

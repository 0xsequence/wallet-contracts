...
interface SubModuleAuthDynamicInterface extends ethers.utils.Interface {
  functions: {
...
export class SubModuleAuthDynamic extends BaseContract {
  ...
  interface: SubModuleAuthDynamicInterface;

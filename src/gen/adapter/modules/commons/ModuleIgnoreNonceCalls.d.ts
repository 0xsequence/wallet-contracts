...
export interface ModuleIgnoreNonceCallsInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "execute" | "nonce" | "readNonce" | "selfExecute" | "supportsInterface"): FunctionFragment;
...
export interface ModuleIgnoreNonceCalls extends BaseContract {

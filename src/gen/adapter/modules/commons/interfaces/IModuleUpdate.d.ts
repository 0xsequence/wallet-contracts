...
export interface IModuleUpdateInterface extends utils.Interface {
    functions: {
        "updateImplementation(address)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "updateImplementation"): FunctionFragment;
...
export interface IModuleUpdate extends BaseContract {

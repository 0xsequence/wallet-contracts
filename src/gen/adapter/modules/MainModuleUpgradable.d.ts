...
export interface MainModuleUpgradableInterface extends utils.Interface {
    functions: {
...
export interface MainModuleUpgradable extends BaseContract {

...
var ReadGapNonceHook__factory = /** @class */ (function (_super) {
    ...
    function ReadGapNonceHook__factory() {
        var args = [];
    ...
    ReadGapNonceHook__factory.createInterface = function () {
        return new ethers_1.utils.Interface(_abi);
    };
    ReadGapNonceHook__factory.connect = function (address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    };
    ReadGapNonceHook__factory.bytecode = _bytecode;
    ReadGapNonceHook__factory.abi = _abi;
